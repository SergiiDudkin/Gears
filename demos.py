...
demo_tooth = HalfTooth(tooth_num=18, module=10.0, pressure_angle=0.3490658503988659, ad_coef=1.0, de_coef=1.0,
                       profile_shift_coef=0.0, cutter_teeth_num=18, resolution=0.1, tolerance=0.1)
